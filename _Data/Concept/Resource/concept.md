...
**정렬 순서 (플레이어·적·보스·투사체 공통, 같은 정렬 레이어 안 `SpriteRenderer` 정렬 순서 값)**
   - 플레이어 2, 적·보스 1, 투사체·보스 전조·히트 이펙트 0 (현행 유지) — 겹침 시 플레이어 > 적·보스 > 그 외 순으로 앞에 그려진다 (`게임컨셉` "겹침 표시 우선순위")
   - 조정 주체는 프리팹이다 — `Object_Player_*` 2, `Object_Enemy_*`·`Object_Boss_*` 1, `Object_Projectile` 0
...
### BGM
**로비·전투**
   - 로비 `BGM_Casual/Lobby`, 전투 `BGM_Casual/Battle` 2건, 보스방은 전투 BGM 재생 속도 1.1배로 긴장감만 올린다 (신규 곡 종류 없음 — 배율 값의 정본은 `밸런스컨셉` "방 종류" Boss BGM 배속·고정값 `Battle_BossBgmPitch`)
...
- 캔버스: 256x256
- 기준 높이: 113 (Apple) / 123 (Banana) / 138 (Watermelon) 잉크 장축 — 위계 판정 프레임은 `Move` 1프레임(이동 시트)이며 Attack·Die 프레임은 "애니메이션 규격"의 동작 프레임 허용 범위를 따른다
...
- 캔버스: 384x384
- 기준 높이: 224 (실측 대조 — Pineapple 잉크 높이 알파>0 경계 실측: Idle 224·253·209·224, Move 183·216·249·232·145·236, Attack1 229·272·184·205·220·228, Attack2 164·226·240·223·220·225, Die 224·199·171·143·102·63. 기준 프레임 Idle_01·Idle_04·Die_01 = 224 정합, 기준 미달 정지 프레임은 Idle_03 209(−15). 화면 실측 219px/1080는 Idle_03 209px = 1.63u = 20.4%에 대응. Pumpkin Idle 225·225·213·223). 허용 범위("애니메이션 규격" 프레임 공통 규칙의 224 적용값): 기준 프레임 Idle_01 217~231, 그 외 프레임 134~280, Die 상한 280 — 실측 Pineapple Idle_01 224·Idle 209~253·Move 145~249·Attack1 184~272·Attack2 164~240·Die ≤ 224, Pumpkin Idle_01 225·Idle 213~225·Move 150~236·Attack1 146~258 전부 범위 안(재제작 대상 없음)
