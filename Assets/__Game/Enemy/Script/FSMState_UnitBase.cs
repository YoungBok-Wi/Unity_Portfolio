...
namespace Game
{
    ...
    public abstract class FSMState_UnitBase : FSMState
    {
        ...
        protected Object_PlayerBase Player => LocalGameManager.instance != null ? LocalGameManager.instance.Player : null;
        protected Object_EnemyBase Enemy => Unit as Object_EnemyBase;
        protected Object_BossBase Boss => Unit as Object_BossBase;
        ...
        {
            return Unit.IsDead.v ? Parent.GetState(UnitConst.StateDie) : null;
        }
        ...
        {
            return LocalGameManager.instance.HitBox(Unit, _center, _size, _damage, _maxHits, 0, 0, false);
        }
        #endregion
    }
}
